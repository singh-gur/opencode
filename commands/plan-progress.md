...
User-supplied hint for this run: $ARGUMENTS

Follow this workflow:
1. Use the `question` tool or closest available user-question tool before analysis to ask which plan to review.
...
Rules:
- Use a user-question tool before doing the main analysis.
