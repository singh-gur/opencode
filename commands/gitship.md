...
4. If there are concerns, stop and ask me for confirmation before continuing. Use the `question` tool or the closest available user-question tool for confirmations or clarifications, grouping related questions in one call where practical. In that confirmation request, summarize:
   - what you found
...
- Use the `question` tool or closest available user-question tool whenever you need user confirmation or clarification.
